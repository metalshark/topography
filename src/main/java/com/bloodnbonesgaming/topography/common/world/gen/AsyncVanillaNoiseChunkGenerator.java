...
import com.bloodnbonesgaming.topography.common.noise.AsyncOctavesNoiseGenerator;
...
//public class AsyncVanillaNoiseChunkGenerator extends ChunkGenerator {
//	   public static final Codec<AsyncVanillaNoiseChunkGenerator> field_236079_d_ = RecordCodecBuilder.create((p_236091_0_) -> {
...
//		      })).apply(p_236091_0_, p_236091_0_.stable(AsyncVanillaNoiseChunkGenerator::new));
//		   });
...
//
//		   });
//		   public static final float[] field_236081_j_ = Util.make(new float[25], (p_236092_0_) -> {
//		      for(int i = -2; i <= 2; ++i) {
//		         for(int j = -2; j <= 2; ++j) {
...
//		   public final AsyncOctavesNoiseGenerator field_222568_o;
//		   public final AsyncOctavesNoiseGenerator field_222569_p;
//		   public final AsyncOctavesNoiseGenerator field_222570_q;
//		   public final INoiseGenerator surfaceDepthNoise;
//		   public final AsyncOctavesNoiseGenerator field_236082_u_;
//		   @Nullable
//		   public final SimplexNoiseGenerator field_236083_v_;
//		   public final BlockState defaultBlock;
//		   public final BlockState defaultFluid;
//		   public final long field_236084_w_;
//		   public final DimensionSettings field_236080_h_;
//		   public final int field_236085_x_;
//
//		   public AsyncVanillaNoiseChunkGenerator(BiomeProvider p_i231903_1_, long p_i231903_2_, DimensionSettings p_i231903_4_) {
//		      this(p_i231903_1_, p_i231903_1_, p_i231903_2_, p_i231903_4_);
//		   }
//
//		   private AsyncVanillaNoiseChunkGenerator(BiomeProvider p_i231904_1_, BiomeProvider p_i231904_2_, long p_i231904_3_, DimensionSettings p_i231904_5_) {
...
//		      this.field_222568_o = new AsyncOctavesNoiseGenerator(this.randomSeed, IntStream.rangeClosed(-15, 0));
//		      this.field_222569_p = new AsyncOctavesNoiseGenerator(this.randomSeed, IntStream.rangeClosed(-15, 0));
//		      this.field_222570_q = new AsyncOctavesNoiseGenerator(this.randomSeed, IntStream.rangeClosed(-7, 0));
...
//		      this.field_236082_u_ = new AsyncOctavesNoiseGenerator(this.randomSeed, IntStream.rangeClosed(-15, 0));
...
//		      return new AsyncVanillaNoiseChunkGenerator(this.biomeProvider.func_230320_a_(p_230349_1_), p_230349_1_, this.field_236080_h_);
//		   }
//
