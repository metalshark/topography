...
public final class ChunkGeneratorNoiseTopo extends ChunkGenerator {
   ...
   public final OctavesNoiseGenerator field_222568_o;
   public final OctavesNoiseGenerator field_222569_p;
   public final OctavesNoiseGenerator field_222570_q;
   public final INoiseGenerator surfaceDepthNoise;
   public final OctavesNoiseGenerator field_236082_u_;
   @Nullable
   ...
   private void fillNoiseColumn(double[] noiseColumn, int noiseX, int noiseZ) {
      ...
      if (this.field_236083_v_ != null) {
         d0 = (double)(getRandomNoise(this.field_236083_v_, noiseX, noiseZ) - 8.0F);
         if (d0 > 0.0D) {
            d1 = 0.25D;
         } else {
            d1 = 1.0D;
