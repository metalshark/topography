package com.bloodnbonesgaming.topography.common.world.gen.feature.structure.pieces;
...
public class FortressPiecesTopo {
	   private static final FortressPiecesTopo.PieceWeight[] PRIMARY_COMPONENTS = new FortressPiecesTopo.PieceWeight[]{new FortressPiecesTopo.PieceWeight(FortressPiecesTopo.Straight.class, 30, 0, true), new FortressPiecesTopo.PieceWeight(FortressPiecesTopo.Crossing3.class, 10, 4), new FortressPiecesTopo.PieceWeight(FortressPiecesTopo.Crossing.class, 10, 4), new FortressPiecesTopo.PieceWeight(FortressPiecesTopo.Stairs.class, 10, 3), new FortressPiecesTopo.PieceWeight(FortressPiecesTopo.Throne.class, 5, 2), new FortressPiecesTopo.PieceWeight(FortressPiecesTopo.Entrance.class, 5, 1)};
	   private static final FortressPiecesTopo.PieceWeight[] SECONDARY_COMPONENTS = new FortressPiecesTopo.PieceWeight[]{new FortressPiecesTopo.PieceWeight(FortressPiecesTopo.Corridor5.class, 25, 0, true), new FortressPiecesTopo.PieceWeight(FortressPiecesTopo.Crossing2.class, 15, 5), new FortressPiecesTopo.PieceWeight(FortressPiecesTopo.Corridor2.class, 5, 10), new FortressPiecesTopo.PieceWeight(FortressPiecesTopo.Corridor.class, 5, 10), new FortressPiecesTopo.PieceWeight(FortressPiecesTopo.Corridor3.class, 10, 3, true), new FortressPiecesTopo.PieceWeight(FortressPiecesTopo.Corridor4.class, 7, 2), new FortressPiecesTopo.PieceWeight(FortressPiecesTopo.NetherStalkRoom.class, 5, 2)};

	   private static FortressPiecesTopo.Piece findAndCreateBridgePieceFactory(FortressPiecesTopo.PieceWeight p_175887_0_, List<StructurePiece> p_175887_1_, Random p_175887_2_, int p_175887_3_, int p_175887_4_, int p_175887_5_, Direction p_175887_6_, int p_175887_7_) {
	      Class<? extends FortressPiecesTopo.Piece> oclass = p_175887_0_.weightClass;
	      FortressPiecesTopo.Piece FortressPiecesTopo$piece = null;
	      if (oclass == FortressPiecesTopo.Straight.class) {
	         FortressPiecesTopo$piece = FortressPiecesTopo.Straight.createPiece(p_175887_1_, p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_);
	      } else if (oclass == FortressPiecesTopo.Crossing3.class) {
	         FortressPiecesTopo$piece = FortressPiecesTopo.Crossing3.createPiece(p_175887_1_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_);
	      } else if (oclass == FortressPiecesTopo.Crossing.class) {
	         FortressPiecesTopo$piece = FortressPiecesTopo.Crossing.createPiece(p_175887_1_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_);
	      } else if (oclass == FortressPiecesTopo.Stairs.class) {
	         FortressPiecesTopo$piece = FortressPiecesTopo.Stairs.createPiece(p_175887_1_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_7_, p_175887_6_);
	      } else if (oclass == FortressPiecesTopo.Throne.class) {
	         FortressPiecesTopo$piece = FortressPiecesTopo.Throne.createPiece(p_175887_1_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_7_, p_175887_6_);
	      } else if (oclass == FortressPiecesTopo.Entrance.class) {
	         FortressPiecesTopo$piece = FortressPiecesTopo.Entrance.createPiece(p_175887_1_, p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_);
	      } else if (oclass == FortressPiecesTopo.Corridor5.class) {
	         FortressPiecesTopo$piece = FortressPiecesTopo.Corridor5.createPiece(p_175887_1_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_);
	      } else if (oclass == FortressPiecesTopo.Corridor2.class) {
	         FortressPiecesTopo$piece = FortressPiecesTopo.Corridor2.createPiece(p_175887_1_, p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_);
	      } else if (oclass == FortressPiecesTopo.Corridor.class) {
	         FortressPiecesTopo$piece = FortressPiecesTopo.Corridor.createPiece(p_175887_1_, p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_);
	      } else if (oclass == FortressPiecesTopo.Corridor3.class) {
	         FortressPiecesTopo$piece = FortressPiecesTopo.Corridor3.createPiece(p_175887_1_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_);
	      } else if (oclass == FortressPiecesTopo.Corridor4.class) {
	         FortressPiecesTopo$piece = FortressPiecesTopo.Corridor4.func_214814_a(p_175887_1_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_);
	      } else if (oclass == FortressPiecesTopo.Crossing2.class) {
	         FortressPiecesTopo$piece = FortressPiecesTopo.Crossing2.createPiece(p_175887_1_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_);
	      } else if (oclass == FortressPiecesTopo.NetherStalkRoom.class) {
	         FortressPiecesTopo$piece = FortressPiecesTopo.NetherStalkRoom.createPiece(p_175887_1_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_);
	      }

	      return FortressPiecesTopo$piece;
	   }

	   public static class Corridor extends FortressPiecesTopo.Piece {
	      ...
	      public void buildComponent(StructurePiece componentIn, List<StructurePiece> listIn, Random rand) {
	         this.getNextComponentX((FortressPiecesTopo.Start)componentIn, listIn, rand, 0, 1, true);
	      }

	      public static FortressPiecesTopo.Corridor createPiece(List<StructurePiece> p_175879_0_, Random p_175879_1_, int p_175879_2_, int p_175879_3_, int p_175879_4_, Direction p_175879_5_, int p_175879_6_) {
	         ...
	         return isAboveGround(mutableboundingbox) && StructurePiece.findIntersecting(p_175879_0_, mutableboundingbox) == null ? new FortressPiecesTopo.Corridor(p_175879_6_, p_175879_1_, mutableboundingbox, p_175879_5_) : null;
	      }
	   ...
	   public static class Corridor2 extends FortressPiecesTopo.Piece {
	      private boolean chest;
	       ...
	       */
	      public void buildComponent(StructurePiece componentIn, List<StructurePiece> listIn, Random rand) {
	         this.getNextComponentZ((FortressPiecesTopo.Start)componentIn, listIn, rand, 0, 1, true);
	      }

	      public static FortressPiecesTopo.Corridor2 createPiece(List<StructurePiece> p_175876_0_, Random p_175876_1_, int p_175876_2_, int p_175876_3_, int p_175876_4_, Direction p_175876_5_, int p_175876_6_) {
	         ...
	         return isAboveGround(mutableboundingbox) && StructurePiece.findIntersecting(p_175876_0_, mutableboundingbox) == null ? new FortressPiecesTopo.Corridor2(p_175876_6_, p_175876_1_, mutableboundingbox, p_175876_5_) : null;
	      }
	   ...
	   public static class Corridor3 extends FortressPiecesTopo.Piece {
	       ...
	       */
	      public void buildComponent(StructurePiece componentIn, List<StructurePiece> listIn, Random rand) {
	         this.getNextComponentNormal((FortressPiecesTopo.Start)componentIn, listIn, rand, 1, 0, true);
	      }

	      public static FortressPiecesTopo.Corridor3 createPiece(List<StructurePiece> p_175883_0_, int p_175883_1_, int p_175883_2_, int p_175883_3_, Direction p_175883_4_, int p_175883_5_) {
	         ...
	         return isAboveGround(mutableboundingbox) && StructurePiece.findIntersecting(p_175883_0_, mutableboundingbox) == null ? new FortressPiecesTopo.Corridor3(p_175883_5_, mutableboundingbox, p_175883_4_) : null;
	      }
	   ...
	   public static class Corridor4 extends FortressPiecesTopo.Piece {
	      ...
	      public void buildComponent(StructurePiece componentIn, List<StructurePiece> listIn, Random rand) {
	         ...
	         this.getNextComponentX((FortressPiecesTopo.Start)componentIn, listIn, rand, 0, i, rand.nextInt(8) > 0);
	         this.getNextComponentZ((FortressPiecesTopo.Start)componentIn, listIn, rand, 0, i, rand.nextInt(8) > 0);
	      }

	      public static FortressPiecesTopo.Corridor4 func_214814_a(List<StructurePiece> p_214814_0_, int p_214814_1_, int p_214814_2_, int p_214814_3_, Direction p_214814_4_, int p_214814_5_) {
	         ...
	         return isAboveGround(mutableboundingbox) && StructurePiece.findIntersecting(p_214814_0_, mutableboundingbox) == null ? new FortressPiecesTopo.Corridor4(p_214814_5_, mutableboundingbox, p_214814_4_) : null;
	      }
	   ...
	   public static class Corridor5 extends FortressPiecesTopo.Piece {
	      ...
	      public static FortressPiecesTopo.Corridor5 createPiece(List<StructurePiece> p_175877_0_, int p_175877_1_, int p_175877_2_, int p_175877_3_, Direction p_175877_4_, int p_175877_5_) {
	         ...
	         return isAboveGround(mutableboundingbox) && StructurePiece.findIntersecting(p_175877_0_, mutableboundingbox) == null ? new FortressPiecesTopo.Corridor5(p_175877_5_, mutableboundingbox, p_175877_4_) : null;
	      }
	   ...
	   public static class Crossing extends FortressPiecesTopo.Piece {
	       ...
	       */
	      public void buildComponent(StructurePiece componentIn, List<StructurePiece> listIn, Random rand) {
	         this.getNextComponentNormal((FortressPiecesTopo.Start)componentIn, listIn, rand, 2, 0, false);
	         this.getNextComponentX((FortressPiecesTopo.Start)componentIn, listIn, rand, 0, 2, false);
	         this.getNextComponentZ((FortressPiecesTopo.Start)componentIn, listIn, rand, 0, 2, false);
	      }

	      public static FortressPiecesTopo.Crossing createPiece(List<StructurePiece> p_175873_0_, int p_175873_1_, int p_175873_2_, int p_175873_3_, Direction p_175873_4_, int p_175873_5_) {
	         ...
	         return isAboveGround(mutableboundingbox) && StructurePiece.findIntersecting(p_175873_0_, mutableboundingbox) == null ? new FortressPiecesTopo.Crossing(p_175873_5_, mutableboundingbox, p_175873_4_) : null;
	      }
	   ...
	   public static class Crossing2 extends FortressPiecesTopo.Piece {
	      ...
	      public static FortressPiecesTopo.Crossing2 createPiece(List<StructurePiece> p_175878_0_, int p_175878_1_, int p_175878_2_, int p_175878_3_, Direction p_175878_4_, int p_175878_5_) {
	         ...
	         return isAboveGround(mutableboundingbox) && StructurePiece.findIntersecting(p_175878_0_, mutableboundingbox) == null ? new FortressPiecesTopo.Crossing2(p_175878_5_, mutableboundingbox, p_175878_4_) : null;
	      }
	   ...
	   public static class Crossing3 extends FortressPiecesTopo.Piece {
	       ...
	       */
	      public void buildComponent(StructurePiece componentIn, List<StructurePiece> listIn, Random rand) {
	         this.getNextComponentNormal((FortressPiecesTopo.Start)componentIn, listIn, rand, 8, 3, false);
	         this.getNextComponentX((FortressPiecesTopo.Start)componentIn, listIn, rand, 3, 8, false);
	         this.getNextComponentZ((FortressPiecesTopo.Start)componentIn, listIn, rand, 3, 8, false);
	      }

	      public static FortressPiecesTopo.Crossing3 createPiece(List<StructurePiece> p_175885_0_, int p_175885_1_, int p_175885_2_, int p_175885_3_, Direction p_175885_4_, int p_175885_5_) {
	         ...
	         return isAboveGround(mutableboundingbox) && StructurePiece.findIntersecting(p_175885_0_, mutableboundingbox) == null ? new FortressPiecesTopo.Crossing3(p_175885_5_, mutableboundingbox, p_175885_4_) : null;
	      }
	   ...
	   public static class End extends FortressPiecesTopo.Piece {
	      ...
	      public static FortressPiecesTopo.End createPiece(List<StructurePiece> p_175884_0_, Random p_175884_1_, int p_175884_2_, int p_175884_3_, int p_175884_4_, Direction p_175884_5_, int p_175884_6_) {
	         ...
	         return isAboveGround(mutableboundingbox) && StructurePiece.findIntersecting(p_175884_0_, mutableboundingbox) == null ? new FortressPiecesTopo.End(p_175884_6_, p_175884_1_, mutableboundingbox, p_175884_5_) : null;
	      }
	   ...
	   public static class Entrance extends FortressPiecesTopo.Piece {
	       ...
	       */
	      public void buildComponent(StructurePiece componentIn, List<StructurePiece> listIn, Random rand) {
	         this.getNextComponentNormal((FortressPiecesTopo.Start)componentIn, listIn, rand, 5, 3, true);
	      }

	      public static FortressPiecesTopo.Entrance createPiece(List<StructurePiece> p_175881_0_, Random p_175881_1_, int p_175881_2_, int p_175881_3_, int p_175881_4_, Direction p_175881_5_, int p_175881_6_) {
	         ...
	         return isAboveGround(mutableboundingbox) && StructurePiece.findIntersecting(p_175881_0_, mutableboundingbox) == null ? new FortressPiecesTopo.Entrance(p_175881_6_, p_175881_1_, mutableboundingbox, p_175881_5_) : null;
	      }
	   ...
	   public static class NetherStalkRoom extends FortressPiecesTopo.Piece {
	      ...
	      public void buildComponent(StructurePiece componentIn, List<StructurePiece> listIn, Random rand) {
	         this.getNextComponentNormal((FortressPiecesTopo.Start)componentIn, listIn, rand, 5, 3, true);
	         this.getNextComponentNormal((FortressPiecesTopo.Start)componentIn, listIn, rand, 5, 11, true);
	      }

	      public static FortressPiecesTopo.NetherStalkRoom createPiece(List<StructurePiece> p_175875_0_, int p_175875_1_, int p_175875_2_, int p_175875_3_, Direction p_175875_4_, int p_175875_5_) {
	         ...
	         return isAboveGround(mutableboundingbox) && StructurePiece.findIntersecting(p_175875_0_, mutableboundingbox) == null ? new FortressPiecesTopo.NetherStalkRoom(p_175875_5_, mutableboundingbox, p_175875_4_) : null;
	      }
	   ...
	   abstract static class Piece extends StructurePiece {
	      ...
	      private int getTotalWeight(List<FortressPiecesTopo.PieceWeight> p_74960_1_) {
	         boolean flag = false;
	         int i = 0;

	         for(FortressPiecesTopo.PieceWeight FortressPiecesTopo$pieceweight : p_74960_1_) {
	            if (FortressPiecesTopo$pieceweight.maxPlaceCount > 0 && FortressPiecesTopo$pieceweight.placeCount < FortressPiecesTopo$pieceweight.maxPlaceCount) {
	               flag = true;
	            }

	            i += FortressPiecesTopo$pieceweight.weight;
	         }

	         return flag ? i : -1;
	      }

	      private FortressPiecesTopo.Piece generatePiece(FortressPiecesTopo.Start p_175871_1_, List<FortressPiecesTopo.PieceWeight> p_175871_2_, List<StructurePiece> p_175871_3_, Random p_175871_4_, int p_175871_5_, int p_175871_6_, int p_175871_7_, Direction p_175871_8_, int p_175871_9_) {
	         ...
	         while(j < 5 && flag) {
	            ...
	            for(FortressPiecesTopo.PieceWeight FortressPiecesTopo$pieceweight : p_175871_2_) {
	               k -= FortressPiecesTopo$pieceweight.weight;
	               if (k < 0) {
	                  if (!FortressPiecesTopo$pieceweight.doPlace(p_175871_9_) || FortressPiecesTopo$pieceweight == p_175871_1_.lastPlaced && !FortressPiecesTopo$pieceweight.allowInRow) {
	                     break;
	                  }

	                  FortressPiecesTopo.Piece FortressPiecesTopo$piece = FortressPiecesTopo.findAndCreateBridgePieceFactory(FortressPiecesTopo$pieceweight, p_175871_3_, p_175871_4_, p_175871_5_, p_175871_6_, p_175871_7_, p_175871_8_, p_175871_9_);
	                  if (FortressPiecesTopo$piece != null) {
	                     ++FortressPiecesTopo$pieceweight.placeCount;
	                     p_175871_1_.lastPlaced = FortressPiecesTopo$pieceweight;
	                     if (!FortressPiecesTopo$pieceweight.isValid()) {
	                        p_175871_2_.remove(FortressPiecesTopo$pieceweight);
	                     }
	         ...
	         return FortressPiecesTopo.End.createPiece(p_175871_3_, p_175871_4_, p_175871_5_, p_175871_6_, p_175871_7_, p_175871_8_, p_175871_9_);
	      }

	      private StructurePiece generateAndAddPiece(FortressPiecesTopo.Start p_175870_1_, List<StructurePiece> p_175870_2_, Random p_175870_3_, int p_175870_4_, int p_175870_5_, int p_175870_6_, @Nullable Direction p_175870_7_, int p_175870_8_, boolean p_175870_9_) {
	         if (Math.abs(p_175870_4_ - p_175870_1_.getBoundingBox().minX) <= 112 && Math.abs(p_175870_6_ - p_175870_1_.getBoundingBox().minZ) <= 112) {
	            List<FortressPiecesTopo.PieceWeight> list = p_175870_1_.primaryWeights;
	            if (p_175870_9_) {
	            ...
	            return FortressPiecesTopo.End.createPiece(p_175870_2_, p_175870_3_, p_175870_4_, p_175870_5_, p_175870_6_, p_175870_7_, p_175870_8_);
	         }
	      }
	       ...
	       */
	      @Nullable
	      protected StructurePiece getNextComponentNormal(FortressPiecesTopo.Start p_74963_1_, List<StructurePiece> p_74963_2_, Random p_74963_3_, int p_74963_4_, int p_74963_5_, boolean p_74963_6_) {
	         Direction direction = this.getCoordBaseMode();
	         if (direction != null) {
	            switch(direction) {
	            case NORTH:
	       ...
	       */
	      @Nullable
	      protected StructurePiece getNextComponentX(FortressPiecesTopo.Start p_74961_1_, List<StructurePiece> p_74961_2_, Random p_74961_3_, int p_74961_4_, int p_74961_5_, boolean p_74961_6_) {
	         Direction direction = this.getCoordBaseMode();
	         if (direction != null) {
	            switch(direction) {
	            case NORTH:
	       ...
	       */
	      @Nullable
	      protected StructurePiece getNextComponentZ(FortressPiecesTopo.Start p_74965_1_, List<StructurePiece> p_74965_2_, Random p_74965_3_, int p_74965_4_, int p_74965_5_, boolean p_74965_6_) {
	         Direction direction = this.getCoordBaseMode();
	         if (direction != null) {
	            switch(direction) {
	            case NORTH:
	   ...
	   static class PieceWeight {
	      public final Class<? extends FortressPiecesTopo.Piece> weightClass;
	      public final int weight;
	      public int placeCount;
	      public final int maxPlaceCount;
	      public final boolean allowInRow;

	      public PieceWeight(Class<? extends FortressPiecesTopo.Piece> p_i2055_1_, int p_i2055_2_, int p_i2055_3_, boolean p_i2055_4_) {
	      ...
	      public PieceWeight(Class<? extends FortressPiecesTopo.Piece> p_i2056_1_, int p_i2056_2_, int p_i2056_3_) {
	   ...
	   public static class Stairs extends FortressPiecesTopo.Piece {
	       ...
	       */
	      public void buildComponent(StructurePiece componentIn, List<StructurePiece> listIn, Random rand) {
	         this.getNextComponentZ((FortressPiecesTopo.Start)componentIn, listIn, rand, 6, 2, false);
	      }

	      public static FortressPiecesTopo.Stairs createPiece(List<StructurePiece> p_175872_0_, int p_175872_1_, int p_175872_2_, int p_175872_3_, int p_175872_4_, Direction p_175872_5_) {
	         ...
	         return isAboveGround(mutableboundingbox) && StructurePiece.findIntersecting(p_175872_0_, mutableboundingbox) == null ? new FortressPiecesTopo.Stairs(p_175872_4_, mutableboundingbox, p_175872_5_) : null;
	      }
	   ...
	   public static class Start extends FortressPiecesTopo.Crossing3 {
	      public FortressPiecesTopo.PieceWeight lastPlaced;
	      public List<FortressPiecesTopo.PieceWeight> primaryWeights;
	      public List<FortressPiecesTopo.PieceWeight> secondaryWeights;
	      ...
	      public Start(Random p_i2059_1_, int p_i2059_2_, int p_i2059_3_) {
	         ...
	         for(FortressPiecesTopo.PieceWeight FortressPiecesTopo$pieceweight : FortressPiecesTopo.PRIMARY_COMPONENTS) {
	            FortressPiecesTopo$pieceweight.placeCount = 0;
	            this.primaryWeights.add(FortressPiecesTopo$pieceweight);
	         }

	         this.secondaryWeights = Lists.newArrayList();

	         for(FortressPiecesTopo.PieceWeight FortressPiecesTopo$pieceweight1 : FortressPiecesTopo.SECONDARY_COMPONENTS) {
	            FortressPiecesTopo$pieceweight1.placeCount = 0;
	            this.secondaryWeights.add(FortressPiecesTopo$pieceweight1);
	         }
	   ...
	   public static class Straight extends FortressPiecesTopo.Piece {
	       ...
	       */
	      public void buildComponent(StructurePiece componentIn, List<StructurePiece> listIn, Random rand) {
	         this.getNextComponentNormal((FortressPiecesTopo.Start)componentIn, listIn, rand, 1, 3, false);
	      }

	      public static FortressPiecesTopo.Straight createPiece(List<StructurePiece> p_175882_0_, Random p_175882_1_, int p_175882_2_, int p_175882_3_, int p_175882_4_, Direction p_175882_5_, int p_175882_6_) {
	         ...
	         return isAboveGround(mutableboundingbox) && StructurePiece.findIntersecting(p_175882_0_, mutableboundingbox) == null ? new FortressPiecesTopo.Straight(p_175882_6_, p_175882_1_, mutableboundingbox, p_175882_5_) : null;
	      }
	   ...
	   public static class Throne extends FortressPiecesTopo.Piece {
	      ...
	      public static FortressPiecesTopo.Throne createPiece(List<StructurePiece> p_175874_0_, int p_175874_1_, int p_175874_2_, int p_175874_3_, int p_175874_4_, Direction p_175874_5_) {
	         ...
	         return isAboveGround(mutableboundingbox) && StructurePiece.findIntersecting(p_175874_0_, mutableboundingbox) == null ? new FortressPiecesTopo.Throne(p_175874_4_, mutableboundingbox, p_175874_5_) : null;
	      }
