...
//                    	Topography.instance.getLog().info(j7 + " " + noiseArray[j7] + " " + d9 + " " + j4);
	...
	public void populateNoiseArray2(double[] noiseArray, double xOffset, double yOffset, double zOffset, int xSize, int ySize, int zSize, double xScale, double yScale, double zScale, double noiseScale)
    {
		int i = 0;
        double d0 = 1.0D / noiseScale;
        int k = -1;
        ...
        for (int l2 = 0; l2 < xSize; ++l2)
        {
            ...
            for (int k3 = 0; k3 < zSize; ++k3)
            {
                ...
                for (int j4 = 0; j4 < ySize; ++j4)
                {
                    ...
                    noiseArray[j7] += d13 * d0;
                    if (l2 == 4 && k3 == 4 && noiseScale == 0.000030517578125)
                    	Topography.instance.getLog().info(j7 + " " + noiseArray[j7] + " " + yOffset + "/" + d9 + " " + yScale);
                }
            }
        }
    }
	
	public void populateNoiseArray(double[] noiseArray, double xOffset, double yOffset, double zOffset, int xSize, int ySize, int zSize, double xScale, double yScale, double zScale, double noiseScale, int yIndex)
    {
		int i = 0;
        double d0 = 1.0D / noiseScale;
        int k = -1;
        ...
        for (int l2 = 0; l2 < xSize; ++l2)
        {
            ...
            for (int k3 = 0; k3 < zSize; ++k3)
            {
                ...
                for (int j4 = 0; j4 < ySize; ++j4)
                {
                    ...
                    noiseArray[j7] += d13 * d0;
                    if (l2 == 4 && k3 == 4 && noiseScale == 0.000030517578125)
                    	Topography.instance.getLog().info(j7 + " " + noiseArray[j7] + " " + d9 + " " + j4 + "/" + yIndex + " " + yOffset);
                }
            }
        }
    }
