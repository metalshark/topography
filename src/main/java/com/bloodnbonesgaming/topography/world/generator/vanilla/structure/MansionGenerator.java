...
public class MansionGenerator extends WoodlandMansion {
	
	final IGenerator generator;

	public MansionGenerator(IGenerator generator) {
		super(null);
	...
	protected StructureStart getStructureStart(int chunkX, int chunkZ) {
		return new MansionGenerator.Start(this.world, this.generator, this.rand, chunkX, chunkZ);
	}
	
	public static class Start extends StructureStart
    {
		static {
    		MapGenStructureIO.registerStructure(MansionGenerator.Start.class, "Mansion");
    	}
        ...
        public Start(World p_i47235_1_, IGenerator p_i47235_2_, Random p_i47235_3_, int p_i47235_4_, int p_i47235_5_)
        {
            super(p_i47235_4_, p_i47235_5_);
            this.create(p_i47235_1_, p_i47235_2_, p_i47235_3_, p_i47235_4_, p_i47235_5_);
        }

        private void create(World p_191092_1_, IGenerator generator, Random p_191092_3_, int p_191092_4_, int p_191092_5_)
        {
            Rotation rotation = Rotation.values()[p_191092_3_.nextInt(Rotation.values().length)];
            ChunkPrimer chunkprimer = new ChunkPrimer();
            generator.generate(p_191092_1_, chunkprimer, p_191092_4_, p_191092_5_, p_191092_3_);
            int i = 5;
            int j = 5;
